...
import org.kangos.device.DeviceSettings.FileUtils;
import org.kangos.device.DeviceSettings.Constants;
...
public class DeviceSettings extends PreferenceFragment
    ...
    public boolean onPreferenceChange(Preference preference, Object newValue) {
        if (preference == mFpsInfo) {
            ...
            Intent fpsinfo = new Intent(this.getContext(), org.kangos.device.DeviceSettings.FPSInfoService.class);
            if (enabled) {
